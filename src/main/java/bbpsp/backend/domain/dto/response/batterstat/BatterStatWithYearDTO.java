...
@Getter
public class BatterStatWithYearDTO {
    ...
    public static BatterStatWithYearDTO createBatterStatDTO(BatterStat b, int year, String teamName) {
        return new BatterStatWithYearDTO(
                year, teamName, b.getG(), b.getAVG(), b.getPA(), b.getAB(), b.getR(),
    ...
    private BatterStatWithYearDTO(int YEAR, String TEAM, int G, Double AVG, int PA, int AB, int R,
